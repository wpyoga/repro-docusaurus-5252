...
async function start(siteDir, cliOptions) {
    ...
    fsWatcher.on('add', () => { console.log(new Date().toJSON(), 'add event', path, details); reload(); });
    fsWatcher.on('change', () => { console.log(new Date().toJSON(), 'change event', path, details); reload(); });
    fsWatcher.on('unlink', () => { console.log(new Date().toJSON(), 'unlink event', path, details); reload(); });
